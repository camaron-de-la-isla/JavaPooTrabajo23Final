 ...
 * @author sergi
 */
public class IntEmpHacerPedidoVista extends javax.swing.JFrame {

    /**
     * Creates new form InterfazEmpleadosVista
     */
    public IntEmpHacerPedidoVista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Interfaz Pedidos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntEmpHacerPedidoVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntEmpHacerPedidoVista().setVisible(true);
            }
        });
    }
