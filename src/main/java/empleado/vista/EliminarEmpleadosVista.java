 ...
 * @author sergi
 */
public class EliminarEmpleadosVista extends javax.swing.JFrame {
    
    
    /**
     * Creates new form EliminarClientesVista
     */
    public EliminarEmpleadosVista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarEmpleadosVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarEmpleadosVista().setVisible(true);
            }
        });
    }
